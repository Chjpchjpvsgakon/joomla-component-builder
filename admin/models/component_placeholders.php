...
class ComponentbuilderModelComponent_placeholders extends JModelAdmin
{
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_componentbuilder.component_placeholders';
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		if ($id != 0 && (!$user->authorise('component_placeholders.edit.state', 'com_componentbuilder.component_placeholders.' . (int) $id))
			|| ($id == 0 && !$user->authorise('component_placeholders.edit.state', 'com_componentbuilder')))
		{
		...
		if ($id != 0 && (!$user->authorise('component_placeholders.edit.created_by', 'com_componentbuilder.component_placeholders.' . (int) $id))
			|| ($id == 0 && !$user->authorise('component_placeholders.edit.created_by', 'com_componentbuilder')))
		{
			// Disable fields for display.
		...
		if ($id != 0 && (!$user->authorise('component_placeholders.edit.created', 'com_componentbuilder.component_placeholders.' . (int) $id))
			|| ($id == 0 && !$user->authorise('component_placeholders.edit.created', 'com_componentbuilder')))
		{
			// Disable fields for display.
	...
	protected function canEditState($record)
	{
		...
		{
			// The record has been set. Check the record permissions.
			$permission = $user->authorise('component_placeholders.edit.state', 'com_componentbuilder.component_placeholders.' . (int) $recordId);
	...
	protected function batchCopy($values, $pks, $contexts)
	{
		...
		if (!$this->canDo->get('component_placeholders.create') && !$this->canDo->get('component_placeholders.batch'))
		{
			return false;
		}
		...
		elseif (isset($values['published']) && !$this->canDo->get('component_placeholders.edit.state'))
		{
				$values['published'] = 0;
		}
	...
	protected function batchMove($values, $pks, $contexts)
	{
		...
		if (isset($values['published']) && !$this->canDo->get('component_placeholders.edit.state'))
		{
