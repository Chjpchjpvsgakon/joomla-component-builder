...
class ComponentbuilderModelComponent_plugins extends JModelAdmin
{
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_componentbuilder.component_plugins';
	...
	public function getItem($pk = null)
	{
		if ($item = parent::getItem($pk))
		{
			...
			if (!empty($item->addjoomla_plugins))
			{
				// Convert the addjoomla_plugins field to an array.
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		if ($id != 0 && (!$user->authorise('component_plugins.edit.state', 'com_componentbuilder.component_plugins.' . (int) $id))
			|| ($id == 0 && !$user->authorise('component_plugins.edit.state', 'com_componentbuilder')))
		{
		...
		if ($id != 0 && (!$user->authorise('component_plugins.edit.created_by', 'com_componentbuilder.component_plugins.' . (int) $id))
			|| ($id == 0 && !$user->authorise('component_plugins.edit.created_by', 'com_componentbuilder')))
		{
			// Disable fields for display.
		...
		if ($id != 0 && (!$user->authorise('component_plugins.edit.created', 'com_componentbuilder.component_plugins.' . (int) $id))
			|| ($id == 0 && !$user->authorise('component_plugins.edit.created', 'com_componentbuilder')))
		{
			// Disable fields for display.
	...
	protected function canEditState($record)
	{
		...
		{
			// The record has been set. Check the record permissions.
			$permission = $user->authorise('component_plugins.edit.state', 'com_componentbuilder.component_plugins.' . (int) $recordId);
	...
	protected function batchCopy($values, $pks, $contexts)
	{
		...
		elseif (isset($values['published']) && !$this->canDo->get('component_plugins.edit.state'))
		{
				$values['published'] = 0;
		}
	...
	protected function batchMove($values, $pks, $contexts)
	{
		...
		if (isset($values['published']) && !$this->canDo->get('component_plugins.edit.state'))
		{
	...
	public function save($data)
	{
		...
		elseif (!isset($data['addjoomla_plugins']))
		{
